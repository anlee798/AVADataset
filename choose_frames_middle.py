...
for filepath,dirnames,filenames in os.walk(r'./choose_frames'):
    ...
    for filename in filenames:
        ...
        temp_num = temp_name + "_" + temp_num + ".jpg"#choose_frames\frames\1  _000061.jpg
        
        srcfile = filepath + '/' + temp_num #./choose_frames\frames\1/    choose_frames\frames\1_000061.jpg
        dstpath = path_temp_name + '/' + temp_num# ./choose_frames_middle/choose_frames\frames\1/  choose_frames\frames\1_000061.jpg
