...
for filepath,dirnames,filenames in os.walk(r'./frames'):
    ...
    if len(filenames)!=0:
        ...
        print("path_temp_name",path_temp_name)
    ...
    for filename in filenames:
        ...
        if temp_num in num_frames:
            ...
            #temp_num = indexnum + "_" + temp_num + ".jpg"
            srcfile = filepath + '/' + temp_num
            #print(srcfile)#./frames\1/1_000001.jpg
            dstpath = path_temp_name + '/' + temp_num
            #print(dstpath)#./choose_frames/frames\1/1_000001.jpg
            # 复制文件
