...
attributes_dict = {'1':dict(aname='behavior', type=2, 
                            options={'0':'normal',
                                    '1':'calling phone',
                                    '2':'playing cell phone',
                                    '3':'drinking',
                                    '4':'smoking'},
...
for i in info:
    ...
    if dirname == temp_dirname:
        ...
        print("files_img_num",files_img_num)
        ...
        for root, dirs, files in os.walk(json_path + dirname, topdown=False):
            if "ipynb_checkpoints" in root:
                continue
            # print("root",root)#root ../../choose_frames_middle/A
            # print("dirs",dirs)#dirs []
            # print("files",files)#files ['A_000061.jpg', 'A_000091.jpg', 'A_000121.jpg', 'A_000151.jpg', 'A_000181.jpg', 'A_000211.jpg', 'A_000241.jpg']
            num_images = 0
            for file in files:
                if '.jpg' in file:
                    ...
                    img_H = sp[0]
                    img_W = sp[1]
        # print(temp_img_path)../../choose_frames_middle/C/C_000241.jpg
        # print(num_images)7
        ...
        #print("vid_list",vid_list)vid_list ['1', '2', '3', '4', '5', '6', '7']
